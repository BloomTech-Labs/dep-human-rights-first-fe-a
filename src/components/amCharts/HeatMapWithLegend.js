...
function HeatMapWithLegend() {
  const heatMap = useRef(null);

  useLayoutEffect(() => {
    var chart = am4core.create('heatMapWithLegend', am4charts.XYChart);
  ...
  return (
    <div
      id="heatMapWithLegend"
      style={{ width: '100%', height: '500px' }}
    ></div>
  );
}

export default HeatMapWithLegend;
