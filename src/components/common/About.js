...
export default function About() {
  return (
    <div className="about">
      <Title level={1} style={{ color: '#205488' }}>
      ...
      <Paragraph className="p">
        ...
        press the U.S. government and private companies to respect human rights
        and the rule of law. When they fail, we step in to demand reform,
        accountability and justice. Around the world, we work where we can best
